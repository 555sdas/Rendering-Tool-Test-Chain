...
class RenderQualityService:
    ...
    def _evaluate_lighting(self, stats: dict[str, Any]) -> dict[str, Any]:
        score = 100.0
        ...
        score = self._deduct(score, deductions, (stats.get("p95_frame_ms") or 0) > 16.67 and (stats.get("avg_gpu") or 0) > 75, 8, "光照/阴影可能带来GPU帧预算压力")
    ...
    def _evaluate_material(self, stats: dict[str, Any]) -> dict[str, Any]:
        score = 100.0
        deductions: list[dict[str, Any]] = []
        recommendations: list[str] = []
    ...
    def _evaluate_post_processing(self, stats: dict[str, Any]) -> dict[str, Any]:
        score = 100.0
        deductions: list[dict[str, Any]] = []
        recommendations: list[str] = []
    ...
    def _evaluate_physics(self, stats: dict[str, Any]) -> dict[str, Any]:
        score = 100.0
        deductions: list[dict[str, Any]] = []
        recommendations: list[str] = []
